...
public class TestP1 {
    public static void main(String[] args){
        ...
        for (int i = 0; i < totalPruebas; i++){
            if (dado.resurrectPlayer()){ // pob. del 30% aproximadamentes
                resurrecciones++;
            }
        }
        ...
        System.out.printf("\n randomPos:" + dado.randomPos(maxPos));
        System.out.printf("\n whoStarts: " + dado.whoStarts(maxPlayers));
        ...
        for (int i = 0; i < totalPruebas; i++){
            maxW = Math.max(maxW, dado.weaponsReward());
            maxS = Math.max(maxS, dado.sheildReward());
        }
